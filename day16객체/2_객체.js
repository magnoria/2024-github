...
//console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList);//순서를 잘타야함
//주간 박스 오피스의 영화 정보 목록

//console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList[1].rank);//주간박스오피스의 2번째 영화 정보의 순위
//console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList[1].movieNm); //주간박스오피스의 2번째 영화정보의 영화명
...
for( let index = 0; index <= 영화정보.boxOfficeResult.weeklyBoxOfficeList.length-1; index++){
    // index는 0부터 주간박스오피스 의 마지막 인덱스까지 1씩 증가 반복하겠다. length중요
    // index 번째의 영화 호출

    let info = 영화정보.boxOfficeResult.weeklyBoxOfficeList[index]; //영화 1개의 정보
   // console.log(info);
