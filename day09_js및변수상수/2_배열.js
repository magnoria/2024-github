/* 
    ...
    - 배열 (Array)
        ...
        5. 배열내 특정한 위치의 요소(값)호출        -> 잊어먹고 있었음
            변수명[인덱스]
        ...
        8. 배열내 요소(데이터) 삭제
            배열변수명.splice(삭제할인덱스 , 삭제개수)     splice : 이어맞추다라는 뜻이 있음
...
//* 변수는 여러개 데이터를 갖는 배열타입 1개 저장 * 변수는 1개의 데이터 만 저장 가능  - 중요

// 변수는 배열타입을 참조하고 배열타입은 리터럴을 참조하고 있다. 
    // 컴퓨터 하드의 저장데이터를 꺼내오는것같은 느낌으로 이해해라
